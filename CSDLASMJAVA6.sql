CREATE DATABASE Tuta_Camera_Store
GO

USE Tuta_Camera_Store
GO
...
INSERT INTO Accounts (Username, Password, Email, Firstname, Lastname, Phone, Province, District, Commune, SpecificAddress)
...
INSERT INTO Orders (AccountId, OrderDate, TotalOrderAmount, Province, District, Commune, SpecificAddress, Email, Firstname, Lastname, Phone)
...
INSERT INTO Cameras (Name, CategoryId, BrandId, Price, Quantity, Introduce, Description1, Description2, Width, Height, Depth, Weight, PrimaryImage, AdditionalImage1, AdditionalImage2, AdditionalImage3)
VALUES ('Canon R8', 1, 1, 15000000, 50, 'Máy ảnh DSLR Canon', 'Đây là mô tả 1', 'Đây là mô tả 2', '10cm', '20cm', '15cm', '1kg', 'image1.jpg', 'image2.jpg', 'image3.jpg', 'image4.jpg'),
       ('Sony A74', 2, 2, 12000000, 40, 'Máy ảnh Mirrorless Nikon', 'Đây là mô tả 1', 'Đây là mô tả 2', '8cm', '18cm', '12cm', '800g', 'image5.jpg', 'image6.jpg', 'image7.jpg', 'image8.jpg'),
       ('Canon R3', 3, 3, 8000000, 30, 'Máy ảnh Compact Sony', 'Đây là mô tả 1', 'Đây là mô tả 2', '6cm', '15cm', '10cm', '500g', 'image9.jpg', 'image10.jpg', 'image11.jpg', 'image12.jpg'),
       ('Canon R10', 4, 4, 5000000, 20, 'Máy ảnh Bridge Fujifilm', 'Đây là mô tả 1', 'Đây là mô tả 2', '7cm', '16cm', '11cm', '600g', 'image13.jpg', 'image14.jpg', 'image15.jpg', 'image16.jpg'),
       ('Canon R6', 5, 5, 3000000, 25, 'Máy ảnh chụp hành động Panasonic', 'Đây là mô tả 1', 'Đây là mô tả 2', '5cm', '12cm', '9cm', '400g', 'image17.jpg', 'image18.jpg', 'image19.jpg', 'image20.jpg');
...
INSERT INTO Authorities (AccountId, RoleId) VALUES
	(1, 'ADMIN'),
	(2, 'USER'),
	(3, 'GUEST'); 